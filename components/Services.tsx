          ...
          <div className="space-y-6">
            <div className="glass-panel p-6 rounded-sm border-l-4 border-l-[#586e45]">
              ...
              <p className="text-slate-400 leading-relaxed">
                A: Nashed Tuned has over a decade of experience with Honda performance engines. From K20 builds to VTEC Turbo conversions, our workshop in Midrand is equipped to handle high-performance engineering that standard mechanics cannot touch.
              </p>
            </div>
            ...
            <div className="glass-panel p-6 rounded-sm border-l-4 border-l-[#586e45]">
              ...
              <p className="text-slate-400 leading-relaxed">
                A: No. While we are famous for performance tuning, we are a fully accredited RMI workshop. We handle standard logbook services, brakes, and diagnostics for all vehicles, maintaining the same precision we apply to race cars.
              </p>
            </div>
          </div>
        </RevealOnScroll>
