    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left w-full">
        <RevealOnScroll className="max-w-3xl">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded border border-[#586e45] bg-[#586e45]/20 text-[#a3b18a] text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/contact"
              className="group px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold uppercase italic tracking-wide shadow-[0_0_20px_rgba(220,38,38,0.4)] transition-all hover:-translate-y-1 skew-x-[-10deg]"
            >
